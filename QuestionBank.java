...
public class QuestionBank {
    ...
    ArrayList<Question> tanong = new ArrayList<>();
    ...
    Question q4 = new Question("Which of the following is NOT an object-oriented programming concept?",
            new String[] { "A. Inheritance", "B. Encapsulation", "C. Polymorphism", "D. Backtracking" }, 'D');
    ...
    Question q7 = new Question("Which of the following paradigms supports recursion as a natural form of iteration?",
    ...
    Question q10 = new Question("Event-driven programming is most commonly used in:",
            new String[] { "A. Operating system kernels", "B. Web and GUI applications", "C. Compiler design",
