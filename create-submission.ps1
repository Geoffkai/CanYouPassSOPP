...
$sourceFiles = @('src', 'pom.xml', 'README.md', 'programming.json', 'theoretical.json', 'launch4j-config.xml', 'build-full.ps1', 'build.ps1', 'run.ps1', 'QUICK_START.md')
...
$standaloneFiles = @('QuizGame.exe', 'src', 'programming.json', 'theoretical.json')
