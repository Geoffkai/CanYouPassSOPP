...
public class Menu extends JPanel {
    ...
    // Main Menu Panel
    BackgroundPanel mainMenu = new BackgroundPanel("src/img/InitialImg/MainMenu.png");

    // Exit Button
    ImageIcon exitIcon = new ImageIcon(
            new ImageIcon("src/img/InitialImg/Exit.png").getImage().getScaledInstance(596, 112, java.awt.Image.SCALE_SMOOTH));
    JButton exitButton = new JButton(exitIcon);

    // School Record Button
    ImageIcon sRIcon = new ImageIcon(new ImageIcon("src/img/InitialImg/SchoolRecord.png").getImage().getScaledInstance(596, 112,
            java.awt.Image.SCALE_SMOOTH));
    JButton sRButton = new JButton(sRIcon);

    // How To Play Button
    ImageIcon hTPIcon = new ImageIcon(
            new ImageIcon("src/img/InitialImg/HowToPlay.png").getImage().getScaledInstance(596, 112, java.awt.Image.SCALE_SMOOTH));
    JButton hTPButton = new JButton(hTPIcon);

    // Classmate Button
    ImageIcon cMIcon = new ImageIcon(
            new ImageIcon("src/img/InitialImg/Classmate.png").getImage().getScaledInstance(596, 112, java.awt.Image.SCALE_SMOOTH));
    JButton cMButton = new JButton(cMIcon);

    // Play Button
    ImageIcon playIcon = new ImageIcon(
            new ImageIcon("src/img/InitialImg/Play.png").getImage().getScaledInstance(668, 152, java.awt.Image.SCALE_SMOOTH));
