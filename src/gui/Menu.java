...
public class Menu extends JPanel {
    ...
    ImageIcon exitIcon = new ImageIcon(
            new ImageIcon("src/img/Exit.png").getImage().getScaledInstance(596, 112, java.awt.Image.SCALE_SMOOTH));
    JButton exitButton = new JButton(exitIcon);

    // School Record Button
    ImageIcon sRIcon = new ImageIcon(new ImageIcon("src/img/SchoolRecord.png").getImage().getScaledInstance(596, 112,
            java.awt.Image.SCALE_SMOOTH));
    JButton sRButton = new JButton(sRIcon);

    // How To Play Button
    ImageIcon hTPIcon = new ImageIcon(
            new ImageIcon("src/img/HowToPlay.png").getImage().getScaledInstance(596, 112, java.awt.Image.SCALE_SMOOTH));
    JButton hTPButton = new JButton(hTPIcon);

    // Classmate Button
    ImageIcon cMIcon = new ImageIcon(
            new ImageIcon("src/img/Classmate.png").getImage().getScaledInstance(596, 112, java.awt.Image.SCALE_SMOOTH));
    JButton cMButton = new JButton(cMIcon);

    // Play Button
    ImageIcon playIcon = new ImageIcon(
            new ImageIcon("src/img/Play.png").getImage().getScaledInstance(668, 152, java.awt.Image.SCALE_SMOOTH));
