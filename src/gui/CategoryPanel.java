...
public class CategoryPanel extends JPanel {
    ...
    ImageIcon selectIcon = new ImageIcon(
            new ImageIcon("src/img/InitialImg/Select.png").getImage().getScaledInstance(382, 93, Image.SCALE_SMOOTH));
    ImageIcon selectActiveIcon = new ImageIcon(
            new ImageIcon("src/img/InitialImg/Selected.png").getImage().getScaledInstance(382, 93, Image.SCALE_SMOOTH));
